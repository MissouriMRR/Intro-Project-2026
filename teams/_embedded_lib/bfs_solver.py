...
class PathSolver:
    ...
    def solve_terrian_path(s, start, end):
        ...
        while True:
            ...
            # No runners left means the frontier is exhausted without reaching
            # `end` - the target is unreachable. Raise instead of looping
            # forever so the scorer records a clean failure for this map.
            if not runner_list:
